 ...
 */
public class TextFileIndexerNew {
   ...
   */
  TextFileIndexerNew(String indexDir) throws IOException {
   ...
   * @param fileName the name of a text file or a folder we wishcto add to the index
