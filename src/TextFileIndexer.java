...
public class TextFileIndexer {
  ...
  private final static String location = "C:\\temp1";
  ...
  public void indexFileOrDirectory(String fileName) throws IOException {
    ...
    for (File f : queue) {
      ...
      try {
        ...
        //===================================================
        fr = new FileReader(f);
        //doc.add(new TextField("contents", fr));  this was the original before moving to lucene alpha
        doc.add(new StringField("contents", fr.toString(), Field.Store.YES));
